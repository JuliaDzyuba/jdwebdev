  ...
  return (
    <div className="page">
      ...
      <ul className="links__menu">
        <li className="linkedin"><a title="Linkedin" href="https://www.linkedin.com/in/julia-dzyuba-252915220/" aria-label="View my linkedin"><span></span>https://linkedin.com</a></li>
